...
import ru.queuejw.mpl.content.settings.activities.AboutSettingsActivity
import ru.queuejw.mpl.content.settings.activities.AllAppsSettingsActivity
import ru.queuejw.mpl.content.settings.activities.AnimationSettingsActivity
import ru.queuejw.mpl.content.settings.activities.ExperimentsSettingsActivity
import ru.queuejw.mpl.content.settings.activities.FeedbackSettingsActivity
import ru.queuejw.mpl.content.settings.activities.FontsSettingsActivity
import ru.queuejw.mpl.content.settings.activities.IconSettingsActivity
import ru.queuejw.mpl.content.settings.activities.NavBarSettingsActivity
import ru.queuejw.mpl.content.settings.activities.ThemeSettingsActivity
import ru.queuejw.mpl.content.settings.activities.TileSettingsActivity
...
class SettingsActivity : AppCompatActivity() {
    ...
    private fun confTouchAnim() {
        viewList.forEach {
            Utils.setViewInteractAnimation(it.first)
        }
    }
    ...
    override fun onResume() {
        super.onResume()
        binding.settingsInclude.themeSub.text = Utils.accentName(this)
